...
- Easy to read. Short plain sentences, Atkinson Hyperlegible for text and a mono font only for numbers. One accent colour per layer (sky, emerald, amber, violet).
- Always something to do next. A goal bar under the header names the next step and shows progress, and locked tabs say how to unlock them.
...
| Archive Access | 400 | Spending telemetry no longer shrinks the bonus |
...
A mystery story told through a tuning minigame. Universal Paperclips and A Dark Room keep people playing by slowly revealing what is going on, and this is Sublight's version of that.
